...
@Component
public class Judge0SubmissionClient {
    ...
    private static final Logger log = LoggerFactory.getLogger(Judge0SubmissionClient.class);

    public void sendSubmission(Judge0RequestDTO judge0RequestDTO) {
        try {
            String jsonBody = objectMapper.writeValueAsString(judge0RequestDTO);
